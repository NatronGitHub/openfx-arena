...
Source1: ImageMagick-6.9.2-10.tar.gz
Source2: OpenColorIO-1.0.9.tar.gz
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-root

BuildRequires: freetype-devel fontconfig-devel libxml2-devel librsvg2-devel pango-devel zlib-devel libpng-devel cmake gcc-c++ mesa-libGL-devel expat-devel libstdc++-static libzip-devel
